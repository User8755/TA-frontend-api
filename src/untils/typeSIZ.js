const typeSiz = [
  ...
  },
  {
    ...
    speciesSIZ: 'Подшлемник /  Шапочка /  Колпак /  Косынка /  Шапка /  Берет',
    issuanceRate: '1 шт.  на 12 мес',
    additionalMeans: '',
    AdditionalIssuanceRate: '',
  ...
  },
  {
    dependence: '1.14.1',
    label:
      'Обувь специальная резиновая или из полимерных материалов для защиты от механических воздействий (истирания)',
    speciesSIZ: 'Сапоги /  Полусапоги',
    issuanceRate: '1 пара на 12 мес',
    additionalMeans: '',
    AdditionalIssuanceRate: '',
  ...
  },
  {
    ...
    AdditionalIssuanceRate: '',
    standart: 'ГОСТ 12.4.032 ИЛИ ГОСТ 12.4.103',
    OperatingLevel: '(То), от кратковременного воздействия открытого плавмени',
  },
  {
    dependence: '4.4.1',
    label:
  ...
  },
  {
    ...
    issuanceRate: '1 шт.  на 12 мес',
    additionalMeans:
      'Костюм (в том числе отдельными предметами: рубашка, сорочка, юбка) /  Комбинезон /  Халат облегченные 1 шт.',
    AdditionalIssuanceRate: '1 шт. на 12 мес',
    standart: 'ГОСТ 12.4.103-2020',
    OperatingLevel: '(З)',
  },
  ...
  },
  {
    ...
    speciesSIZ: 'Кепка /  Бейсболка /  Колпак /  Козырек /  Косынка /  Пилотка',
    issuanceRate: '1 шт.  на 12 мес',
    additionalMeans: '',
    AdditionalIssuanceRate: '',
    standart: 'ТР ТС 019/2011, или ТР ТС 017/2011, или ГОСТ 12.4.280-2014',
